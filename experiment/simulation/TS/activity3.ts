let act3_n_rings;
let act3_inter_rings: Chemistry.Inter_Rings;
let act3_msr: number = 0;
let act3_table: string;
let act3_num_of_readings = 0;
let frg_show: HTMLInputElement;
//let prs_show: HTMLInputElement;
let act3_app_pres_show: HTMLInputElement;
let act3_new_row: boolean = true;
let act3_tab: Table;
...
let act3_my_canvas1: HTMLCanvasElement;
let act3_my_canvas2: HTMLCanvasElement;
let act3_my_canvas3: HTMLCanvasElement;

let act3_my_context1: CanvasRenderingContext2D;
let act3_my_context2: CanvasRenderingContext2D;
let act3_my_context3: CanvasRenderingContext2D;

let act3_scene1: Scene_Canvas;
...
function activity3() {
	...
	frg_show = <HTMLInputElement>document.getElementById('frg-inp');
	frg_show.value = '00';
	act3_app_pres_show = <HTMLInputElement>document.getElementById('app-prs-inp');
	act3_app_pres_show.value = '00';

	act3_my_canvas1 = <HTMLCanvasElement>document.getElementById('act3_mycanvas1');
	act3_my_canvas2 = <HTMLCanvasElement>document.getElementById('act3_mycanvas2');
	act3_my_canvas3 = <HTMLCanvasElement>document.getElementById('act3_mycanvas3');
...
function act3_draw_all_canvas() {
	...
	let a3_fine_up_btn: HTMLButtonElement = <HTMLButtonElement>(
		document.getElementById('a3-btn-fine-up')
	);
	let a3_fine_down_btn: HTMLButtonElement = <HTMLButtonElement>(
		document.getElementById('a3-btn-fine-down')
	);
	let a3_reset: HTMLButtonElement = <HTMLButtonElement>(
		document.getElementById('a3-re-center')
	);
...
function act3_load_canvas2_images() {
	...
	inter_rings = new Chemistry.Inter_Rings(
		...
		selected_ring_color,
		new Chemistry.Point(
			act3_my_canvas2.width / (2 * lscale) + 5,
			act3_my_canvas2.height / (2 * lscale)
		),
		act3_my_canvas2
	);
	...
	let mscope_img = new Chemistry.Custome_image(
		mscope,
		new Chemistry.Point(
			act3_my_canvas2.width / (2 * lscale),
			act3_my_canvas2.height / (2 * lscale)
		),
		860,
		860,
...
function act3_load_canvas3_images() {
	let pressure_setup_img = new Chemistry.Custome_image(
		pressure_setup,
...
function act3_add_readings() {
	...
	let btn:HTMLButtonElement = <HTMLButtonElement>document.getElementById("a3-add-reading");
